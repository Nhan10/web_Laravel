        ...
        <div class="col-md-6 offset-md-3">
            ...
            <form action="{{route('nhacungcap.update',$nhacungcap->MaNCC)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input required type="text" class="form-control" id="text" value="{{$nhacungcap->TenNCC}}" name="tenNCC">
                </div>
                <div class="form-group">
                    <label for="text" class="text-dark">Địa chỉ:</label>
                    <input required type="text" class="form-control" id="text" value="{{$nhacungcap->DiaChi}}" name="diaChi">
                </div>
                <div class="form-group">
                    <label for="text" class="text-dark">Số điện thoại:</label>
                    <input required type="text" class="form-control" id="text" value="{{$nhacungcap->SDT}}" name="sDT">
                </div>
