            ...
            <form action="{{route('nguoidung.update',$nguoidung->MaND)}}" method="POST">
                ...
                <div class="form-row">
                    <div class="col-md-5">
                        ...
                        <input required type="text" class="form-control" id="text" value="{{$nguoidung->TenND}}" name="tenND">
                    </div>
                    <div class="col-md-7">
                        <label for="text" class="text-dark">Email:</label>
                        <input required type="email" class="form-control" id="text" value="{{$nguoidung->email}}" name="email">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input required type="text" class="form-control" id="text" value="{{$nguoidung->DiaChi}}" name="diaChi">
                </div>
                <div class="form-row">
                    <div class="col">
                        <label for="text" class="text-dark">Số điện thoại:</label>
                        <input required type="text" class="form-control" value="{{$nguoidung->SDT}}" id="text" name="sDT">
                    </div>
                </div>
