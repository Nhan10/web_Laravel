...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="{{Route('nhacungcap.create')}}" class="m-0 font-weight-bold btn btn-danger">Thêm mới</a>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered text-dark" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($nhacungcaps as $nhacungcap)
                        <tr>
                            ...
                            <th>
                                <a href="{{route('nhacungcap.edit',$nhacungcap->MaNCC)}}" class="btn btn-facebook">Edit</a>
